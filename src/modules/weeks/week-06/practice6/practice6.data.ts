...
export const practice6Questions: Practice6Question[] = [
  ...
  // Pregunta 4 — Captura y registro de un documento firmado
  {
    ...
    options: [
      ...
      { id: "copia", label: "Copia personal firmada sin función documental" },
  ...
  // Pregunta 14 — Responsabilidades en la verificación de firmas
  {
    ...
    points: 1,
    concepts: [
      { id: "revisar-vigencia", label: "Revisar la vigencia del certificado" },
      { id: "registrar-firma", label: "Registrar la firma recibida" },
      { id: "comprobar-integridad", label: "Comprobar la integridad del documento" },
    ...
    correctPairs: {
      ...
      "comprobar-integridad": "area-gestion",
    ...
    justifyMinWords: 10,
    expectedSummary: "Distintos roles participan: responsable técnico (vigencia), área de gestión documental (integridad), mesa de partes (registro), TI (evidencia), control interno (supervisión).",
    feedbackByVerdict: {
