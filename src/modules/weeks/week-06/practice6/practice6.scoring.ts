...
export function evaluateQuestion6(question: Practice6Question, value: AnswerValue6): EvalResult {
  switch (question.kind) {
    case "selectJustify": {
      const q = question as SelectJustifyQuestion;
      const v = value as Extract<AnswerValue6, { kind: "selectJustify" }>;
    ...
    case "openText": {
      ...
      const v = value as Extract<AnswerValue6, { kind: "openText" }>;
    ...
    case "dragClassify": {
      ...
      const v = value as Extract<AnswerValue6, { kind: "dragClassify" }>;
    ...
    case "reorder": {
      ...
      const v = value as Extract<AnswerValue6, { kind: "reorder" }>;
    ...
    case "matchPairs": {
      ...
      const v = value as Extract<AnswerValue6, { kind: "matchPairs" }>;
    ...
    case "compareChoice": {
      ...
      const v = value as Extract<AnswerValue6, { kind: "compareChoice" }>;
    ...
    case "editFields": {
      ...
      const v = value as Extract<AnswerValue6, { kind: "editFields" }>;
      let scoreSum = 0;
    ...
    case "stageFlow": {
      ...
      const v = value as Extract<AnswerValue6, { kind: "stageFlow" }>;
    ...
    case "matrixBuilder": {
      ...
      const v = value as Extract<AnswerValue6, { kind: "matrixBuilder" }>;
...
/** Same attempt-based reduction as Week 5's `pointsForVerdict5`: first-try full credit, second-try reduced. */
export function pointsForVerdict6(verdict: Verdict, attemptNumber: 1 | 2, points: number): number {
  if (attemptNumber === 1) {
