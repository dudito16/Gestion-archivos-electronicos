...
import type { AnswerValue6, MatchPairsQuestion } from "../practice6.types";
...
/** Click a concept, then its matching definition. When the question carries a `justifyPrompt`,
 *  matching first reveals a justification field before submitting. */
export function MatchPairsView6({ question, disabled, onCheck }: Props) {
    ...
    <div className="space-y-md">
      ...
      {matched && question.justifyPrompt && (
        <div className="space-y-sm pt-sm border-t border-outline-variant">
          <OpenTextField id={`mp6-${question.id}`} label={question.justifyPrompt} value={justification} onChange={setJustification} rows={3} disabled={disabled} />
