...
import { keyIdeas } from "../week02.data";

export function KeyIdeasSection() {
  return (
    <section id="ideas-clave" className="scroll-mt-24 space-y-lg">
      <SectionHeading eyebrow="Cinco ideas clave" title="Lo esencial de la Semana 2" />

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-md">
        {keyIdeas.map((point, index) => {
