...
import { summaryPoints } from "../week01.data";

export function SummarySection() {
  return (
    <section id="resumen" className="scroll-mt-24 space-y-lg">
      <SectionHeading eyebrow="Resumen" title="Lo esencial de la Semana 1" />
        ...
        {summaryPoints.map((point, index) => {
          ...
          return (
            ...
            >
              ...
              <h4 className="text-body-lg font-body-lg font-semibold text-on-surface mb-1">{point.title}</h4>
              <p className="text-caption font-caption text-on-surface-variant">{point.description}</p>
            </motion.div>
          );
        })}
      </div>
