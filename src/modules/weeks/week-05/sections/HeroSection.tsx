...
import { heroChain } from "../week05.data";

export function Week05HeroSection() {
  return (
    <section
      id="introduccion"
    ...
    >
      <div className="relative z-10 flex-1 space-y-sm">
        ...
        >
          ¿Qué hace que un documento sea confiable como evidencia?
        </motion.p>
        <motion.p
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Estudiaremos los principios de la gestión de documentos y los cuatro requisitos —autenticidad, fiabilidad,
          integridad y disponibilidad— que sostienen su valor como evidencia de la actividad institucional.
        </motion.p>
      </div>
