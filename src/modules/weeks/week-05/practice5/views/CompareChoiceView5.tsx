...
import type { AnswerValue5, CompareChoiceQuestion } from "../practice5.types";
...
export function CompareChoiceView5({ question, disabled, onCheck }: Props) {
  ...
  return (
    <div className="space-y-md">
      ...
      <OpenTextField id={`cc5-${question.id}`} label="Justifica tu decisión." value={justification} onChange={setJustification} rows={3} disabled={disabled} />
