...
import type { AnswerValue5, SelectJustifyQuestion } from "../practice5.types";
...
export function SelectJustifyView5({ question, disabled, onCheck }: Props) {
