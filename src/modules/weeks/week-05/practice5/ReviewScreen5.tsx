...
import { practice5Questions } from "./practice5.data";
import { cn } from "../../../../utils/cn";
import type { Question5Result, Verdict } from "./practice5.types";
...
export function ReviewScreen5({ resultados }: Props) {
  return (
    <div className="space-y-sm">
      {practice5Questions.map((q) => {
