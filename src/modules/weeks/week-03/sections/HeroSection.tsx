...
import { heroChain } from "../week03.data";

export function Week03HeroSection() {
  return (
    <section
      id="introduccion"
    ...
    >
      <div className="relative z-10 flex-1 space-y-sm">
        ...
        >
          Procesos documentales y organización de expedientes en un SGD
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Del documento al expediente: cómo se gestionan, ordenan y controlan los documentos electrónicos.
        </motion.p>
        <motion.p
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Analizaremos qué ocurre con un documento desde su recepción o producción hasta su archivo, y cómo el SGD
          permite controlar su relación con expedientes y procesos.
        </motion.p>
      </div>
