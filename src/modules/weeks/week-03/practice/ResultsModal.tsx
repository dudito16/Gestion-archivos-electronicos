...
export function ResultsModal({ nombreCompleto, nombreGrupo, score, onContinue }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-md" role="dialog" aria-modal="true">
      ...
      >
        <p className="text-headline-md font-headline-md text-on-surface">🎉 PRÁCTICA FINALIZADA</p>
        <p className="text-body-lg font-body-lg text-on-surface">Felicitaciones, {nombreCompleto}.</p>
        <p className="text-body-md font-body-md text-on-surface-variant">Has terminado la Práctica Calificada de la Semana 3.</p>
        ...
        <div className="rounded-lg border border-outline-variant bg-surface-container-low p-md space-y-1 text-left">
          ...
          <div className="flex justify-between pt-2">
            ...
            <span className="text-label-md font-label-md font-bold text-primary-container">{score} / {MAX_SCORE}</span>
          </div>
