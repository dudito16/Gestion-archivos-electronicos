...
import { useWeek4Activities, type ActivityId } from "../activitiesProgress";
...
/** Consistent "lab card" chrome for every Week 4 activity: number, title, objetivo, instrucciones, work area. */
export function ActivityShell({ id, number, title, objective, instructions, children }: ActivityShellProps) {
  const { isCompleted } = useWeek4Activities();
