...
import { practice4Questions } from "./practice4.data";
import { cn } from "../../../../utils/cn";
import type { Question4Result, Verdict } from "./practice4.types";
...
export function ReviewScreen4({ resultados }: Props) {
  return (
    <div className="space-y-sm">
      {practice4Questions.map((q) => {
