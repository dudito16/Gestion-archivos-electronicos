...
export function ResultsModal4({ nombreCompleto, nombreGrupo, score, onContinue }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-md" role="dialog" aria-modal="true">
      ...
      >
        <p className="text-headline-md font-headline-md text-on-surface">🎉 PRÁCTICA CALIFICADA 4 FINALIZADA</p>
        <p className="text-body-lg font-body-lg text-on-surface">Felicitaciones, {nombreCompleto}.</p>
        <p className="text-body-md font-body-md text-on-surface-variant">
          Has finalizado la Práctica Calificada 4. Revisa la retroalimentación de tus respuestas para identificar los aspectos que puedes mejorar.
        </p>
