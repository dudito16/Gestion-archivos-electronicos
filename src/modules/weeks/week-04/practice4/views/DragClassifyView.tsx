...
import type { AnswerValue4, DragClassifyQuestion } from "../practice4.types";
...
export function DragClassifyView({ question, disabled, onCheck }: Props) {
    ...
    <div className="space-y-md">
      ...
      {result && question.justifyPrompt && (
        <div className="space-y-sm pt-sm border-t border-outline-variant">
          <OpenTextField id={`dc-${question.id}`} label={question.justifyPrompt} value={justification} onChange={setJustification} rows={2} />
          <Button
