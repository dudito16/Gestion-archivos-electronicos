...
import type { AnswerValue4, CompareChoiceQuestion } from "../practice4.types";
...
export function CompareChoiceView({ question, disabled, onCheck }: Props) {
  ...
  return (
    <div className="space-y-md">
      ...
      <OpenTextField id={`cc-${question.id}`} label="Justifica tu decisión." value={justification} onChange={setJustification} rows={3} disabled={disabled} />
