...
import type { AnswerValue4, SelectJustifyQuestion } from "../practice4.types";
...
export function SelectJustifyView({ question, disabled, onCheck }: Props) {
