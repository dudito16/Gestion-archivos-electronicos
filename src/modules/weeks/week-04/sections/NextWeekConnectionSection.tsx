...
import { nextWeekConnection } from "../week04.data";

export function NextWeekConnectionSection() {
  return (
    <section id="conexion-semana-5" className="scroll-mt-24 space-y-lg">
      ...
      <div className="rounded-xl border border-outline-variant bg-gradient-to-br from-surface-container-lowest to-surface-container-low p-lg">
        <div className="flex flex-col items-center gap-xs text-center">
          <span className="text-label-md font-label-md font-semibold uppercase tracking-wider text-primary-container">Semana 4</span>
